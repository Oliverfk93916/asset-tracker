...
<div class="row">
	<div class="col-8 mx-auto">
		...
		<!-- SUBMIT BUTTON -->
			<div class="d-grid gap-4 col-6 mx-auto">
    			<button data-bs-toggle="collapse" href="#multiCollapseExample2" aria-expanded="false" aria-controls="multiCollapseExample2" class="btn btn-dark stocktakeSubmit" type="submit"on:click|preventDefault={()=>handleSubmit('headset')}>Submit</button>
   			</div>
    	</div>
  	</div>
</div>
